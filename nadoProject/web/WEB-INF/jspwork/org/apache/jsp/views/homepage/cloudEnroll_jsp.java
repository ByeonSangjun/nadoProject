 ...
 * Generated at: 2019-11-03 15:30:30 UTC
...
public final class cloudEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("#logo {\r\n");
      out.write("\tborder: solid 2px rgb(77, 36, 151);\r\n");
      ...
      out.write("\t\t\t\t\t\t<h1 class=\"text-info text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"/nado/index.jsp\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"font-size: 70px; font-weight: bold; text-decoration: none; color: #4d2497;\">NADO</a>\r\n");
      out.write("\t\t\t\t\t\t</h1>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"아이디(최소5글자)\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"phone\" class=\"form-control\" placeholder=\"-없이 숫자만 입력하세요.\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"phoneAlertBox\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"padding: 10px 0 10px 0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"email\">이메일</label> <input type=\"email\" name=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"email\" class=\"form-control\" placeholder=\"이메일주소\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"sample6_extraAddress\" placeholder=\"참고항목\"><span> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"sample6_execDaumPostcode()\" value=\"우편번호 찾기\" id=\"btn1\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"detailAddress\" id=\"detailAddress\" placeholder=\"상세주소\">\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"submit\" class=\"form-control btn-info abb\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"가입신청\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
