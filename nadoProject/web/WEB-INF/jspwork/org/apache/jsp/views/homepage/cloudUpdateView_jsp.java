 ...
 * Generated at: 2019-11-04 05:34:10 UTC
...
public final class cloudUpdateView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser.getClId().equals("nado")){ 
      ...
      out.write("\t\t\t\t<div class=\"card\" style=\"margin-top:200px;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"card-body\" style=\"padding: 50px\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-title\" style=\"margin-bottom: 50px\">\r\n");
      out.write("\t\t\t\t\t\t\t<h4 class=\"text\">회원정보수정</h4>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"card-text\">\r\n");
      out.write("\t\t\t\t\t\t\t<form id=\"updateForm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"cl_no\" name=\"cl_no\" value=\"");
      out.print( loginUser.getClNo() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"padding: 10px 0 10px 0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"emp_name\">이름</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"emp_name\" id=\"emp_name\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print( loginUser.getClName() );
      out.write("\" readonly style=\"color:black;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"padding: 10px 0 10px 0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"user_id\" id=\"user_id_lable\">아이디</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"user_id\" id=\"user_id\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"user_pwd\" id=\"user_pwd\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"비밀번호를 입력하세요.\" value=\"");
      out.print( loginUser.getClPwd() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"pwdAlertBox\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"password\" id=\"user_pwd2\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"비밀번호확인\" value=\"");
      out.print( loginUser.getClPwd() );
      out.write("\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"padding: 10px 0 10px 0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"phone\">전화번호</label> <input type=\"tel\" name=\"phone\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"phone\" class=\"form-control\" value=\"");
      out.print( loginUser.getClPhone() );
      out.write("\" placeholder=\"-없이 숫자만 입력하세요.\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle=\"color:black;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div id=\"phoneAlertBox\"></div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\" style=\"padding: 10px 0 10px 0;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"email\">이메일</label> <input type=\"email\" name=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"email\" class=\"form-control\" value=\"");
      out.print( loginUser.getClEmail() );
      out.write("\" placeholder=\"이메일주소\" style=\"color:black;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div style=\"display: inline;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"postcode\" style=\"display: block;\">주소</label> <input style=\"float:left; width:120px; color:black;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"postcode\" id=\"postcode\" placeholder=\"우편번호\" class=\"form-control\" value=\"");
      out.print( postcode );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"sample6_extraAddress\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tid=\"sample6_extraAddress\" placeholder=\"참고항목\" class=\"form-control\" style=\"color:black;float:left; width:120px;\" value=\"");
      out.print( extraAddress );
      out.write("\"><span> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"button\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tonclick=\"sample6_execDaumPostcode()\" value=\"우편번호 찾기\" id=\"btn1\" style=\"float:right; width:120px;\"></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<p style=\"clear:both; margin:0 0 0 0; padding:0 0 0 0;\">&nbsp;</p>\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" style=\"color:black;\"class=\"form-control\" name=\"address\" id=\"address\" placeholder=\"주소\" value=\"");
      out.print( address );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" style=\"color:black;\"class=\"form-control\" name=\"detailAddress\" id=\"detailAddress\" placeholder=\"상세주소\" value=\"");
      out.print( detailAddress );
      out.write("\">\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"submit\" class=\"form-control btn-info abb\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"수정\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- card-text 끝 -->\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- card-body 끝 -->\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- card 끝 -->\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<!-- col-lg-6 끝 -->\r\n");
      out.write("\t\t\t<div class=\"col-lg-2\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 로우 끝 -->\r\n");
      out.write("\t</div>\r\n");
