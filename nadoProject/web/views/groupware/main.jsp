...
<!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. 색상들 변경됨-->
   ...
   <div class="wrapper">
         ...
         <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
               <ul class="nav navbar-nav">
                        ...
                        <li>
                           ...
                           <ul class="menu">
                              ...
                              <li><a href="#">
                                    ...
                                    <h4>
                                       보낸사람 이름<small><i class="fa fa-clock-o"></i> 시간</small>
                                    </h4>
                                    <p>쪽지 내용</p>
                              </a></li>
                              ...
                              <li><a href="#">
                                    ...
                                    <h4>
                                       AdminLTE Design Team <small><i class="fa fa-clock-o"></i> 2시간</small>
                                    </h4>
                              ...
                              <li><a href="#">
                                    ...
                                    <h4>
                                       Developers <small><i class="fa fa-clock-o"></i>오늘</small>
                                    </h4>
                                    <p>Why not buy a new awesome theme?</p>
                              </a></li>
                              <li><a href="#">
                                    ...
                                    <h4>
                                       Sales Department <small><i class="fa fa-clock-o"></i>어제</small>
                                    </h4>
                                    <p>Why not buy a new awesome theme?</p>
                              </a></li>
                              <li><a href="#">
                                    ...
                                    <h4>
                                       Reviewers <small><i class="fa fa-clock-o"></i> 2일</small>
                                    </h4>
                                    <p>Why not buy a new awesome theme?</p>
                              </a></li>
                           </ul>
                  ...
                  <i class="fa fa-bell"></i> <span class="label label-warning">10</span></a>
                     <ul class="dropdown-menu">
                        <li class="header">10개의 알림이 있습니다.</li>
                        <li>
                           <!-- 알림 토글 버튼 드롭다운 메뉴 inner menu: contains the actual data -->
                           <ul class="menu">
                              <li><a href="#"> <i class="fa fa-clipboard text-blue"></i>
                                    전자결재가 승인되었습니다.
                              </a></li>
                              <li><a href="#"> <i class="fa fa-calendar text-yellow"></i> 오늘의 일정이 있습니다.
                              </a></li>
                              <li><a href="#"> <i class="fa fa-envelope text-purple"></i> 새로운 메일이 도착했습니다.
                              </a></li>
                              <li><a href="#"> <i class="fa fa-table text-green"></i> 새로운 댓글이 달렸습니다.
                              </a></li>
                              <li><a href="#"> <i class="fa fa-calendar-check-o text-red"></i> 예약신청이 반려되었습니다.
                              </a></li>
                           </ul>
                        </li>
                  ...
                  </a> <!-- 프로필 부분 클릭했을 때 드롭다운 메뉴 -->
                     <ul class="dropdown-menu">
                        <!-- 프로필 사진 User image -->
                        <li class="user-header">
                           <% if(loginEmp.getMyProfile() != null) { %> <img
                           src="/nado/resources/groupware/employee_profile/<%= loginEmp.getMyProfile() %>"
                           class="img-circle" alt="User Image"> <% } else { %> <img
                           src="/nado/resources/groupware/employee_profile/default-profile.png"
      ...
      <aside class="main-sidebar">
         ...
         <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
               ...
               <!-- 전자결재 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-clipboard"></i> <span>전자결재</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="/nado/ealist"><i class="fa fa-angle-right"></i> 기안하기</a></li>
                     <li><a href="/nado/eatlist"><i class="fa fa-angle-right"></i> 진행중인 문서</a></li>
                     <li><a href="/nado/eadtlist"><i class="fa fa-angle-right"></i> 문서함</a></li>
                     <li><a href="/nado/views/groupware/approval/approvalSetting.jsp"><i class="fa fa-angle-right"></i> 설정</a></li>
                  </ul></li>

               <!-- 조직도 메뉴 -->
               <li class="notreeview"><a href="/nado/emplist"> <i class="fa fa-group"></i> <span>조직도</span></a></li>

               <!-- 전자메일 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-envelope"></i> <span>전자메일</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="/nado/emlist"><i class="fa fa-angle-right"></i> 메일쓰기</a></li>
                     <li><a href="/nado/views/groupware/email/emailSelfForm.jsp"><i class="fa fa-angle-right"></i> 내게 쓰기</a></li>
                     <li><a href="/nado/listall"><i class="fa fa-angle-right"></i> 전체 메일함</a></li>
                     <li><a href="/nado/emsl"><i class="fa fa-angle-right"></i> 보낸 메일함</a></li>
                     <li><a href="/nado/emr"><i class="fa fa-angle-right"></i> 받은 메일함</a></li>
                     <li><a href="/nado/esl"><i class="fa fa-angle-right"></i> 임시 메일함</a></li>
                     <li><a href="/nado/sers"><i class="fa fa-angle-right"></i> 내게 쓴 메일함</a></li>
                     <li><a href="/nado/emt"><i class="fa fa-angle-right"></i> 휴지통</a></li>
                  </ul></li>

               <!-- 캘린더 메뉴 -->
               <li class="notreeview"><a href="/nado/calsa"> <i class="fa fa-calendar-o"></i><span>캘린더</span></a></li>

               <!-- 게시판 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-table"></i><span>게시판</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="/nado/nlist.ad"><i class="fa fa-angle-right"></i> 공지사항</a></li>
                     <li><a href="/nado/blist"><i class="fa fa-angle-right"></i> 자유게시판</a></li>
                  </ul></li>

               <!-- 주소록 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-address-book"></i> <span>주소록</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="#"><i class="fa fa-angle-right"></i> 주소록 추가</a></li>
                     <li><a href="#"><i class="fa fa-angle-right"></i> 개인 주소록</a></li>
                     <li><a href="#"><i class="fa fa-angle-right"></i> 공유 주소록</a></li>
                  </ul></li>

               <!-- 예약 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-calendar-check-o"></i> <span>예약</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="#"><i class="fa fa-angle-right"></i> 예약하기</a></li>
                     <li><a href="#"><i class="fa fa-angle-right"></i> 예약 조회</a></li>
                     <li><a href="/nado/rvmsa"><i class="fa fa-angle-right"></i> 나의 예약 조회</a></li>
                     <li><a href="/nado/rvasa.ad"><i class="fa fa-angle-right"></i> 예약 관리</a></li>
                  </ul></li>
               <!-- 마이페이지 메뉴 -->
               <li class="treeview"><a href="#"> <i class="fa fa-user-circle"></i> <span>마이페이지</span> 
               <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i></span></a>
                  <ul class="treeview-menu">
                     <li><a href="#"><i class="fa fa-angle-right"></i> 근태 관리</a></li>
                     <li><a href="#"><i class="fa fa-angle-right"></i> 쪽지함</a></li>
                     <li><a href="#"><i class="fa fa-angle-right"></i> 내 정보 관리</a></li>
                  </ul></li>
            </ul>
         </section>
      ...
      <nav class="navbar navbar-static-top">
         <!-- 관리자 페이지 토글 버튼 Sidebar toggle button-->
            ...
            <div class="navbar-custom-menu">
               ...
               <!-- 관리자 페이지 쪽지 드롭다운 메뉴 끝 -->

               <!-- 관리자 페이지 알림 토글 버튼 Notifications: style can be found in dropdown.less -->
               <li class="dropdown notifications-menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-bell"></i> <span class="label label-warning">14</span></a>
                  <ul class="dropdown-menu">
                     <li class="header">14개의 알림이 있습니다.</li>
                     <li>
                        <!-- 관리자 페이지 알림 토글 버튼 드롭다운 메뉴 inner menu: contains the actual data -->
                        <ul class="menu">
                           <li><a href="#"> <i class="fa fa-clipboard text-blue"></i> 전자결재가 승인되었습니다.</a></li>
                           <li><a href="#"> <i class="fa fa-calendar text-yellow"></i> 오늘의 일정이 있습니다.</a></li>
                           <li><a href="#"> <i class="fa fa-envelope text-purple"></i> 새로운 메일이 도착했습니다.</a></li>
                           <li><a href="#"> <i class="fa fa-table text-green"></i> 새로운 댓글이 달렸습니다.</a></li>
                           <li><a href="#"> <i class="fa fa-calendar-check-o text-red"></i> 예약신청이 반려되었습니다.</a></li>
                        </ul>
                        </li>
                        <li class="footer"><a href="#">전체 보기</a></li>
                     </ul></li>
               ...
               <li class="dropdown user user-menu"><a href="#"
                  class="dropdown-toggle" data-toggle="dropdown"> <!-- 관리자 페이지 오른쪽 상단 프로필 사진 -->
                     <% if(loginEmp.getMyProfile() != null) { %> 
                     <img src="/nado/resources/groupware/employee_profile/<%= loginEmp.getMyProfile() %>" class="user-image" alt="User Image"> <% } else { %> 
                     <img src="/nado/resources/groupware/employee_profile/default-profile.png" class="user-image" alt="User Image"> <% } %> <span class="hidden-xs"><%= loginEmp.getEmpName() %></span>
               </a> <!-- 관리자 페이지 프로필 부분 클릭했을 때 드롭다운 메뉴 -->
                  <ul class="dropdown-menu">
                     <!-- 프로필 사진 User image -->
                     <li class="user-header">
                        <% if(loginEmp.getMyProfile() != null) { %> 
                        <img src="/nado/resources/groupware/employee_profile/<%= loginEmp.getMyProfile() %>" class="img-circle" alt="User Image"> <% } else { %> 
                        <img src="/nado/resources/groupware/employee_profile/default-profile.png" class="img-circle" alt="User Image"> <% } %>
                        <p>관리자</p>
                        <p><%= loginEmp.getEmpName() %></p>
                     </li>
      ...
      <aside class="main-sidebar">
         ...
         <section class="sidebar">
            ...
            <!-- 관리자 메뉴 -->
            <ul class="sidebar-menu" data-widget="tree">
               <li><a href="/nado/empic.ad"> <i class="fa fa-drivers-license"></i> <span>사용자승인관리</span></a></li>
               <li><a href="#"> <i class="fa fa-group"></i> <span>조직도</span></a></li>
               <li class="treeview"><a href="#"> <i class="fa fa-list"></i><span>게시판 관리</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span></a>
                  <ul class="treeview-menu">
                     <li><a href="/nado/nlist.ad"> <i class="fa fa-angle-right"></i> 공지사항</a></li>
                     <li><a href="/nado/blist"> <i class="fa fa-angle-right"></i> 자유게시판</a></li>
                  </ul></li>
      ...
      <footer class="main-footer">
         ...
         <strong>Copyright &copy; 2019 <a href="/nado/index.jsp">NADO Groupware</a>.</strong> All rights reserved.
      </footer>
