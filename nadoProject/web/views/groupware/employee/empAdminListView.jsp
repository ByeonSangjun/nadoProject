...
<div id="emplist.ad" name="emplist.ad">
	<div id="a" name="a" style="border:2px solid #4d2498;background-color:#f3f1fa;height:700px;width:800px;float:left;">
...
<h1 align="center">회원 전체 목록 : <%= list.size() %> 명</h1>
<br>
<table align="center" border="1" cellspacing="1" cellpadding="5">
	...
	<div id="b" name="b" style="border:2px solid #4d2498;background-color:#f3f1fa;height:700px;width:200px;float:left;">
	알로에
	</div>
</div>
