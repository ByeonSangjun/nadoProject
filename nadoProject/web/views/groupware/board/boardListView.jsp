...
<a href="/nado/blist?page=1">|◁</a> &nbsp;
<% if((beginPage - 10) < 1){ %>
	<a href="/nado/blist?page=1">◀◀</a>
<% }else{ %>
	<a href="/nado/blist?page=<%= beginPage - 10 %>">◀◀</a>
<% } %> &nbsp;
<% for(int p = beginPage; p <= endPage; p++){ 
		if(p == currentPage){
%>
	<a href="/nado/blist?page=<%= p %>"><font color="red"><b>[<%= p %>]</b></font></a>
<% }else{ %>
	<a href="/nado/blist?page=<%= p %>"><%= p %></a>
<% }}  %> &nbsp;
<% if((endPage + 10) > maxPage){ %>
	<a href="/nado/blist?page=<%= maxPage %>">▶▶</a>
<% }else{ %>
	<a href="/nado/blist?page=<%= endPage + 10 %>">▶▶</a>
<% } %> &nbsp;
<a href="/nado/blist?page=<%= maxPage %>">▷|</a>
...
<div class="searchbox" style="text-align: center; width: 280px;">
		...
		<% if(manager.equals("M")){ %><div style="float: right;"><button onclick="callFunction();">새 게시글 등록</button></div><% }%>
