...
<h3 align="center">관리자용 공지글 등록 페이지</h3>

<div style="align:center;width:100%;">
<form action="/nado/nwrite.ad" method="post" enctype="multipart/form-data">
...
<input type="submit" value="등록하기" onclick="submitContents(this);">	&nbsp;
<a href="JavaScript:window.location.reload()">다시 작성</a>&nbsp;/&nbsp;<a href="/nado/nlist.ad">취소</a> &nbsp; </th></tr>
<tr>
<th width="60%" style="padding-left:20px;">제목 :&nbsp;<input type="text" name="title" style="width:500px;"></th>
<th width="18%">작성자 :&nbsp;<input type="text" name="writer" value="<%= loginEmp.getUserId() %>" readonly style="width:120px;"></th>
<th width="70px"></th>
<th width="70px"></th>
</tr>
...
<tr><th colspan="4"><textarea name="ir1" id="ir1" rows="13" cols="148"></textarea></th></tr>
...
<tr><th colspan="4" style="text-align:left; padding-left:40px; padding-bottom:10px;"><input type="file" name="upfile"></th></tr>
