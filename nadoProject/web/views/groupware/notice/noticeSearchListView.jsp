...
function callFunction(){
	//자바스크립트로 서블릿 요청할 경우
	window.location.href = "/nado/views/groupware/notice/noticeWriteForm.jsp";
...
<tr><th colspan="6">
<h6 align="right">조회갯수 : <%= listCount %> 개</h6><h6 align="right"><a href="/nado/nlist.ad">전체 목록 보기</a></h6><br>
</th></tr>
<tr>
		<th>번호</th>
...
<% for(Notice n : list){ %>
<tr>
		<td align="center"><strong><%= n.getNoticeNo() %></strong></td>
		<td><a href="/nado/ndetail.ad?no=<%= n.getNoticeNo() %>"><%= n.getNoticeTitle() %></a></td>
		<td><%= n.getUserId() %></td>
		<td align="center">
		...
		<td align="center"><%= n.getNoticeReadCount() %></td>
</tr>
<% } %>
</table>
</div>
...
<a href="/nado/nsearch.ad?page=1&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">|◁</a> &nbsp;
<% if((beginPage - 10) < 1){ %>
	<a href="/nado/nsearch.ad?page=1&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">◀◀</a>
<% }else{ %>
	<a href="/nado/nsearch.ad?page=<%= beginPage - 10 %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">◀◀</a>
<% } %> &nbsp;
<% for(int p = beginPage; p <= endPage; p++){ 
		if(p == currentPage){
%>
	<a href="/nado/nsearch.ad?page=<%= p %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>"><font color="red"><b>[<%= p %>]</b></font></a>
<% }else{ %>
	<a href="/nado/nsearch.ad?page=<%= p %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>"><%= p %></a>
<% }}  %> &nbsp;
<% if((endPage + 10) > maxPage){ %>
	<a href="/nado/nsearch.ad?page=<%= maxPage %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">▶▶</a>
<% }else{ %>
	<a href="/nado/nsearch.ad?page=<%= endPage + 10 %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">▶▶</a>
<% } %> &nbsp;
<a href="/nado/nsearch.ad?page=<%= maxPage %>&Titlekeyword=<%= titlekeyword%>&Writerkeyword=<%= writerkeyword%>">▷|</a>
...
<div class="searchbox" style="text-align: center; width: 280px;">
		...
		<form action="/nado/nsearch.ad" method="get">
