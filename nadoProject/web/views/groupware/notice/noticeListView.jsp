...
<html>
<head>
<meta charset="utf-8"><!-- <META HTTP-EQUIV="refresh" CONTENT="0.1"> -->
...
<a href="/nado/nlist.ad?page=1">|◁</a> &nbsp;
<% if((beginPage - 10) < 1){ %>
	<a href="/nado/nlist.ad?page=1">◀◀</a>
<% }else{ %>
	<a href="/nado/nlist.ad?page=<%= beginPage - 10 %>">◀◀</a>
<% } %> &nbsp;
<% for(int p = beginPage; p <= endPage; p++){ 
		if(p == currentPage){
%>
	<a href="/nado/nlist.ad?page=<%= p %>"><font color="red"><b>[<%= p %>]</b></font></a>
<% }else{ %>
	<a href="/nado/nlist.ad?page=<%= p %>"><%= p %></a>
<% }}  %> &nbsp;
<% if((endPage + 10) > maxPage){ %>
	<a href="/nado/nlist.ad?page=<%= maxPage %>">▶▶</a>
<% }else{ %>
	<a href="/nado/nlist.ad?page=<%= endPage + 10 %>">▶▶</a>
<% } %> &nbsp;
<a href="/nado/nlist.ad?page=<%= maxPage %>">▷|</a>
