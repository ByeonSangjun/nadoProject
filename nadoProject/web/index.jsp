            ...
            <div class="row">
               ...
               <div class="col-lg-6">
                  <div class="about_content">
                     ...
                     <div class="about_text">
                        ...
                        <br>
                        <div>
                           <img id="i_1" width="600" height="300"
                              src="/nado/resources/homepage/images/전자결재_상세보기.png">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-6">
                  <div class="about_content">
                     <br>
                     <br>
                     <div class="about_title" id="title11">
                        <h2>전자결재</h2>
                     </div>
                     <div class="about_text" id="content11">
                        <h4>실시간 결재로 빠르게 의사결정을 진행하세요.</h4>
                     </div>
                     <br>
                     <br>
                     <div class="about_images d-flex flex-row align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="1">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/check.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="2">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/envelope.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>전자메일</h4>
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="3">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/calendar.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>캘린더</h4>
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="4">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/blackboard.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>게시판</h4>
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="5">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/network.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>조직도</h4>
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="6">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/feedback.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>채팅</h4>
                              </div>
                        ...
                        <!-- Icon Box -->
                        <div class="col-lg-4 icon_box_col">
                           <div class="icon_box d-flex flex-column align-items-center justify-content-start text-center" id="7">
                              <div class="icon_box_icon">
                                 <img src="/nado/resources/homepage/images/agenda.svg" style="cursor: pointer" class="svg" alt="https://www.flaticon.com/authors/monkik">
                              </div>
                              <div class="icon_box_title">
                                 <h4>주소록</h4>
                              </div>
